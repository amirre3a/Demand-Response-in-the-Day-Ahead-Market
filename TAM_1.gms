...
obj..                    OF=e=sum(t,sum(g,gendata(g,'a')*sqr(Pg(g,t))+Pg(g,t)*gendata(g,'b')+gendata(g,'a')*u(g,t)))+sum((bus,t),+Phs(bus,t)*VOLL);
...
Parameter DL_tot,DLmax,TDpay,TGEN_prof,PLT(t),D_avg,LF        ;
...
TDpay = sum(bus, sum(t$t1(t),Price(t,'d')*DL.l(bus,t)) + sum(t$t2(t),Price(t,'d')*DL.l(bus,t)) + sum(t$t3(t),100*DL.l(bus,t)) );

TGEN_prof = sum(bus, sum(t$t1(t),Price(t,'d')*DL.l(bus,t)) + sum(t$t2(t),Price(t,'d')*DL.l(bus,t)) + sum(t$t3(t),100*DL.l(bus,t))
